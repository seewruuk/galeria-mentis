                    ...
                    <div className="">
                        <div className={"flex justify-between"}>
                            ...
                            <div className="max-w-xl flex flex-col gap-4 items-start">
                                <Link href={"/dashboard/orders"}
                                      className={"text-[12px] font-medium underline text-blue-600"}>Back to orders</Link>
                        ...
                        <section aria-labelledby="order-heading" className="mt-10 border-t border-gray-200">
                            ...
                            {order.products && order.products.map((item, index) => (
                                <div key={item + index} className="flex space-x-[32px] border-b border-gray-200 py-10">
                                    ...
                                    <div>
                                        ...
                                        <dd className="mt-2 text-gray-700">
                                            <address className="not-italic">
                                                <span className="block">{order.personData.name} {order.personData.lastname}</span>
                                                <span className="block">{order.personData.email}</span>
                                                <span className="block">Phone: {order.personData.phone}</span>
                                                <span className="block">{order.personData.address}, {order.personData.apartment}</span>
                                                <span className="block">{order.personData.city}, {order.personData.country}</span>
                                                <span className="block">{order.personData.state}, {order.personData.postal}</span>
