        ...
        <div className={"mt-[120px] bg-black"}>
            <Layout>
                <section className={"py-[12px]"}>
                    ...
                    <div className={"border-t-gray border-t-2 pt-[16px] flex justify-between text-gray text-[14px] max-lg:flex-col max-lg:gap-5 max-lg:text-center"}>
                        <span>
                            Copyright © {new Date().getFullYear()} {process.env.NEXT_PUBLIC_COMPANY_NAME}
                        </span>
                        <span>
                            Website created by <Link className={"text-primary"} href={process.env.NEXT_PUBLIC_AUTHOR_SITE} target={"_blank"}>{process.env.NEXT_PUBLIC_AUTHOR_NAME}</Link>
                        </span>
                    </div>
                </section>
            </Layout>
